...
const EditJobPage = ({ updateJob }) => {
	...
	const [type, setType] = useState(singleJob.type);
	const [location, setLocation] = useState(singleJob.location);
	const [description, setDescription] = useState(singleJob.description);
	const [salary, setSalary] = useState(singleJob.salary);
	const [companyName, setCompanyName] = useState(singleJob.company.name);
